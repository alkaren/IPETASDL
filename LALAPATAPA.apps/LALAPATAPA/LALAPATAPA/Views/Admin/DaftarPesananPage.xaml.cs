...
namespace LALAPATAPA.Views.Admin
{
    ...
    public partial class DaftarPesananPage : ContentPage
    {
        HeaderTransactionViewModel vm;
        public string IdTransaction { get; set; }
        public string TransactionStatus { get; set; }
        public string createdDate { get; set; }
        public DaftarPesananPage()
        {
            ...
            //selesailist.ItemsSource = DaftarPesananFactory.Selesais;
        ...
        public async void Configuration()
        {
            ...
            var TransBaru = from x in content
                               where x.TransactionStatus == "MENUNGGU PERSETUJUAN"
                               select x;
        ...
        //    try
        //    {
        //        var obj = (HeaderTransaction)e.SelectedItem;
        //        var ide = Convert.ToInt32(obj.TransactionStatus);
        //        //Convert.ToInt32(ide);
        //    }
        //    catch (Exception er)
        //    {
        ...
        private async void OnTappedPesanan(object sender, ItemTappedEventArgs e)
        {
            ...
            await Navigation.PushModalAsync(new NavigationPage(new RincianPesananPage(mylist)));
        }
        #region button
