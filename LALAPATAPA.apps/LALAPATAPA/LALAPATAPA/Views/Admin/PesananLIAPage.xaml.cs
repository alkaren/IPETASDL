...
namespace LALAPATAPA.Views.Admin
{
    ...
    public partial class PesananLIAPage : ContentPage
    {
        ...
        public PesananLIAPage()
        {
            ...
            //selesailist.ItemsSource = PesananLIAFactory.Proses;
        ...
        private async void OnTappedPesanan(object sender, ItemTappedEventArgs e)
        {
            ...
            await Navigation.PushModalAsync(new NavigationPage(new RincianPesananLIAPage(mylist)));
        }
